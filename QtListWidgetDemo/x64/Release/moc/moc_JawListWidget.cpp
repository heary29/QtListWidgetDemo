...
#include <memory>
#include "../../../../JawListWidget/JawListWidget.h"
...
QT_MOC_LITERAL(4, 33, 10) // "updateItem"

    },
    "JawListWidget\0openItem\0\0varValue\0"
    "updateItem"
};
...
void JawListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateItem((*reinterpret_cast< const QVariant(*)>(_a[1]))); break;
        default: ;
        }
